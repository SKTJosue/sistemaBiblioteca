...
import { LibrosRegistradosComponent } from './components/libros-registrados./libros-registrados..component';
import { PagesBuscadorComponent} from './pages/pages-buscador/pages-buscador.component';
const routes: Routes = [
  ...
  {path: 'usuario-registrados',component: UsuariosRegistradosComponent},
  ...
  {path:'registro-libros',component:LibrosRegistradosComponent},
  {path:'buscador-pages',component:PagesBuscadorComponent},
];
